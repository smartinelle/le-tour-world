...
def test_parse_all_fields():
    ...
    This hex fixture contains: flags=0x001A, power=355W, speed=9.216m/s, cadence=85rpm
    ...
    frame = bytes([
        ...
        0x00, 0x24,  # speed: 9216 => 9.216 m/s (0x2400 in little endian)
    ...
    assert abs(result.speed_mps - 9.216) < 0.001
